...
2. Write a paragraph (<100 words) describing an example of what you consider data science. Write your paragraph in R Markdown. Include at least 
    ...
    Data science extracting knowledge and insights from data in various forms, both structured and unstructured, similar to data mining. It's purpose is to help people and companies make more informed decisions. It's basically just taking a set of data and finding out what it means.
